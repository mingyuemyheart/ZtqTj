 ...
 * @author Z 空气质量
 */
public class FragmentAirRandkingT extends Fragment implements OnClickListener {
    ...
    private void reqD(String reqcode) {
        ...
        showProgressDialog();
        PackAirRankNewUp packDetialup = new PackAirRankNewUp();
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            whatMessage=packKey.dicList.get(msg.what).rankType;
            reqD(whatMessage);
        }
    };
...
//                chagesequ(adapter.isDown);
    ...
    private class MyReceiver extends PcsDataBrocastReceiver {
        ...
        public void onReceive(String name, String errorStr) {
            if (name.equals(PackAirRankNewUp.NAME)) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    ActivityAirQualityProvinceRranking.reqCode = whatMessage;
