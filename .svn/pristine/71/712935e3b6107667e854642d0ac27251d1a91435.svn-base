 ...
 *
 */
public class AdapterFamilySelectCityExpandableListView extends
	...
	public AdapterFamilySelectCityExpandableListView(Context context) {
...
//		holder.image.setVisibility(View.VISIBLE);
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		PackLocalCity pack = (PackLocalCity) getChild(groupPosition,
				childPosition);
		holder.tv.setText(pack.SHOW_NAME);
	...
	public void setSearchStr(String str) {
		// 省份
		mListProvice.clear();
		mListProvice.addAll(ZtqCityDB.getInstance().searchProvince(str));  ;
		// 城市
		mListCity.clear();
        List<PackLocalCity> citys;
        citys = ZtqCityDB.getInstance().searchCity(str);
		if(citys != null && citys.size() > 0) {
            mListCity.addAll(citys);
        }
