 ...
 * @author chenjh
 */
public class ActivityGuideForecast extends FragmentActivitySZYBBase {
    ...
    private void initEvent() {
        ...
        expandablelistview.setOnChildClickListener(new OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                Intent intent = new Intent(ActivityGuideForecast.this, ActivityDetailNumericalForecast.class);
                ...
                if (listLeve1.get(groupPosition).name.trim().equals("福建省气象台指导预报") || listLeve1.get(groupPosition).name.trim().equals("中央气象台指导预报")) {
                ...
                if (listLeve2.get(groupPosition).get(childPosition).name.trim().equals("国内天气公报")) {
                    if (toast == null) {
                        toast = Toast.makeText(ActivityGuideForecast.this, "无数据", Toast.LENGTH_SHORT);
                    } else {
                        toast.setText("无数据");
                    }
                    toast.show();
    ...
    private void gridViewClick(int position) {
        ...
        switch (position) {
            case 0:
                it.setClass(ActivityGuideForecast.this, ActivityDetailCenterPro.class);
                break;
            case 1:
                it.setClass(ActivityGuideForecast.this, ActivityDetailCenterPro.class);
                break;
    ...
    private void initData() {
        ...
        adapter = new AdapterNumericalForecast(ActivityGuideForecast.this, listLeve1, listLeve2);
    ...
    private void showAppraisalDailog() {
        ...
        dialog = new DialogTwoButton(ActivityGuideForecast.this, view, "取消", "提交", new DialogFactory.DialogListener() {
            @Override
    ...
    private class MyReceiver extends PcsDataBrocastReceiver {
        ...
        public void onReceive(String nameStr, String errorStr) {
            if (packNumericalForecastColumnUp.getName().equals(nameStr)) {
                ...
                gridAdapter = new AdapterColumn(ActivityGuideForecast.this, listLeve1, getImageFetcher());
