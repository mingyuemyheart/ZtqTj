...
import com.pcs.ztqtj.view.fragment.warning.video.CornerUtils;
...
public class ActionSheetDialog extends BottomBaseDialog {
     ...
     */
    private int itemTextColor = Color.parseColor("#526cfd");
    /**
    ...
    public View onCreateView() {
        ...
        lv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, 1));
    ...
    public void setUiBeforShow() {
        ...
        /** title underline */
        v_line_title.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dp2px(dividerHeight_DP)));
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv_item.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
