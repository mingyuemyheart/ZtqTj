...
import com.pcs.ztqtj.view.fragment.warning.video.StatusBarUtils;
...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    /**
     * set Ui data or logic opreation before attatched
     * window(在对话框显示之前,设置界面数据或者逻辑)
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ll_top, new ViewGroup.LayoutParams(dm.widthPixels,
                (int) maxHeight));
    ...
    public void onAttachedToWindow() {
        ...
        ll_control_height.setLayoutParams(new LinearLayout.LayoutParams(width,
                height));
