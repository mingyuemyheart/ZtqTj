...
//    private float widthc = 0;
    ...
    public Hour24View_En(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
...
//        CircleR2 = Util.dip2px(context, 6);
        ...
        mPoint3Paint.setColor(Color.argb(255, 255, 102, 0));
        // 高低温度点
...
//        mLine1Paint.setColor(Color.argb(200, 255, 255, 255));
        ...
        mLine1Paint = DrawViewTool.getInstance().getMyLine(Color.argb(255, 255, 102, 0), widtha);
        ...
        mTextPaint.setColor(Color.argb(255, 255, 102, 0));
        ...
        paintRain = new Paint();
        paintRain.setColor(Color.argb(255, 72, 117, 165));
...
//        viewWidth = getWidth();
        ...
        float tempHeight = getHeight();//温度图
