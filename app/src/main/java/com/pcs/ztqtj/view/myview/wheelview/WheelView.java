...
package com.pcs.ztqtj.view.myview.wheelview;
...
//	private int[] SHADOWS_COLORS = new int[] { 0xefE9E9E9, 0xcfE9E9E9, 0x3fE9E9E9 };
	private int[] SHADOWS_COLORS = new int[] { 0x60ffffff, 0x00ffffff, 0x60ffffff };
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.shawn_wheel_bg;
	private int wheelForeground = R.drawable.shawn_wheel_val;
