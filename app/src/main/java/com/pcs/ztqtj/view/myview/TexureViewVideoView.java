...
/**
 * Created by tyaathome on 2017/12/20.
 */
 ...
 */
public class TexureViewVideoView extends TextureView implements MediaPlayerControl {
    ...
    public TexureViewVideoView(Context context) {
        super(context);
        mContext = context;
        initVideoView();
    }

    public TexureViewVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        mContext = context;
        initVideoView();
    }

    public TexureViewVideoView(Context context, AttributeSet attrs, int defStyle) {
