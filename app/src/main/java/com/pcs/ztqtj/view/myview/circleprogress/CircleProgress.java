package com.pcs.ztqtj.view.myview.circleprogress;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {0xff64E364, 0xffFFFF66, 0xffFF6700, 0xffFF0000, 0xffCC3399, 0xff993333};
    //当前进度，[0.0f,1.0f]
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        initAttrs(attrs);
        initPaint();
        setValue(mValue, mValueColor, (String) mUnit);
    }
...
//        mValuePaint.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mHintOffset = mCenterPoint.y - mRadius * mTextOffsetPercentInRadius - 2*getBaselineOffsetFromY(mHintPaint);//hint向上偏移1/3
        mUnitOffset = mCenterPoint.y + mRadius * mTextOffsetPercentInRadius + 3*getBaselineOffsetFromY(mUnitPaint);//unit向下偏移1/3
        updateArcPaint();
     ...
     * @param value
     */
    public void setValue(float value, int valueColor, String unit) {
