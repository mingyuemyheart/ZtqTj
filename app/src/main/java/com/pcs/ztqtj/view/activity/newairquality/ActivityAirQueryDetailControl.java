...
public class ActivityAirQueryDetailControl {
    ...
    private ActivityAirQualityQuery activity;

    public ActivityAirQueryDetailControl(ActivityAirQualityQuery activity) {
