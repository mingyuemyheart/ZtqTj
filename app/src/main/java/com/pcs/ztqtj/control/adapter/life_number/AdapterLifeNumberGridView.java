...
public class AdapterLifeNumberGridView extends BaseAdapter {
    ...
    public AdapterLifeNumberGridView(Activity activity, List<LifeNumber> localNum) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            Picasso.get().load(activity.getString(R.string.shzs)+ packLocal.ico_path).into(holder.icon);
