...
public class AdapterExpertList extends BaseAdapter {
    ...
    public AdapterExpertList(List<ItemExpert> listData, ImageFetcher imageFetcher) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        ItemExpert item = listData.get(position);
        ...
        if (!TextUtils.isEmpty(imagePath) || "null".equals(imagePath)) {
            imageFetcher.loadImage(parent.getContext().getString(R.string.file_download_url) + imagePath, holder.item_img, ImageConstant.ImageShowType.SRC);
        }
        return view;
    }
