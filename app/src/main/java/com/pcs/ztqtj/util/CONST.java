...
public class CONST {
    ...
    public static String BASE_IP = "http://220.243.129.159:8081";
    public static String GEO_URL = BASE_IP+"/geo/station/parse";
    public static String BASE_URL = BASE_IP+"/tjapi/app/";


    public static final String PROTOCAL = "http://220.243.129.159:8081/web/tjfile/smart/yhxy.html";//用户协议
    public static final String PRIVACY = "http://220.243.129.159:8081/web/tjfile/smart/yszc.html";//隐私政策
